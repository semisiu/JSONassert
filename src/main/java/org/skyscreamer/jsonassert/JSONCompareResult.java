...
import org.skyscreamer.jsonassert.diff.viewer.DiffViewer;
...
public class JSONCompareResult {
    ...
    public String getMessage() {
        String diffView = JSONAssertConfiguration.isDiffViewerEnabled() ? DiffViewer.diff(_expected, _actual) : "";
        return _message.toString() + diffView;
    }
